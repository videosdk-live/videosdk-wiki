...
class CreateStreamFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_create_stream, container, false)
        val etName = view.findViewById<EditText>(R.id.etName)
        val txtMeetingId = view.findViewById<TextView>(R.id.txtStreamId)
        ...
        btnCreate.setOnClickListener { v: View? ->
            if ("" == etName.text.toString()) {
                ...
                intent.putExtra("streamId", finalMeetingId)
                intent.putExtra(
                    "webcamEnabled",
                ...
                intent.putExtra("mode", "SEND_AND_RECV")
